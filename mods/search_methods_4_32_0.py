...
def new_greedy_search(
    ...
    input_ids_cd: Optional[torch.LongTensor] = None,  # AllPath: New arg
    **model_kwargs,
    ...
    while True:
        ...
        graber["is_vcd_branch"] = False  # AllPath: Added
        outputs = self(
            **model_inputs,
            return_dict=True,
        ...
        if use_cd:
            ...
            if graber["use_cd"] == "vcd":
                graber["is_vcd_branch"] = True  # AllPath: Added
            outputs_cd = self(
                **model_inputs_cd,
                return_dict=True,
                output_attentions=(
